...
- Submit a pull request to yorkie-team/yorkie-android-sdk
...
We strictly follow the official Kotlin code style guide(https://kotlinlang.org/docs/reference/coding-conventions.html) with few additional rules:
- we only use single name import
